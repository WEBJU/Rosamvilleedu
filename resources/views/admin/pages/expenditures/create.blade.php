    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <h1 style="margin-left:20px;">Add Expenditure</h1>
            ...
            <form class="form-horizontal" action="/saveExpenditure" enctype="multipart/form-data" method="POST">
                @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea class="form-control"name="description" rows="5" placeholder="Give detailed description of the spenditure "></textarea>
                      </div>
                    </div>
                    <div class="form-group">
